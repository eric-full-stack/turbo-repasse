      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Seja você que queira apenas um carro, ou viver de revenda, temos o
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
              ...
              {['Mensal', 'Anual'].map((period) => (
                <RadioGroup.Option
                  ...
                  className={clsx(
                    ...
                    period === 'Mensal' ? 'rounded-l-lg' : '-ml-px rounded-r-lg'
                  )}
                >
                  {period}
                </RadioGroup.Option>
            ...
            <div
              aria-hidden="true"
              className={clsx(
                'pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-red-600 transition-all duration-300',
                activePeriod === 'Mensal'
